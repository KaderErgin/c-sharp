...
namespace TelefonUygulamasi
{
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            kişilerismi.Add("Kader");
            kişilerismi.Add("Hakan");
            kişilerismi.Add("Cansu");
            kişilerismi.Add("Derya");
            kişilerismi.Add("Mehmet");
            kişilersoyismi.Add("Demir");
            kişilersoyismi.Add("Goksu");
            kişilersoyismi.Add("Erener");
            kişilersoyismi.Add("Akyazı");
            kişilersoyismi.Add("Cideli");
            kişilerTelNo.Add("05493461158");
            kişilerTelNo.Add("05342548248");
            kişilerTelNo.Add("05347833333");
            kişilerTelNo.Add("05347844544");
            kişilerTelNo.Add("055448554557");
